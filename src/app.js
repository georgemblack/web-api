...
app.post('/views', async (req, res) => {
  ...
  if (req.get('Sec-CH-Platform')) clientHints.platform = req.get('Sec-CH-Platform')
  ...
  if (req.get('Sec-CH-Viewport-Width')) clientHints.viewportWidth = req.get('Sec-CH-Viewport-Width')
  ...
  if (Object.keys(clientHints).length !== 0) docPayload.clientHints = clientHints
